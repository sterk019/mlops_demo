...
feature_table_name = f"ml_course.{DA.schema_name}.features"
...
fl_handle = fl_handle = FeatureLookup(
...
with mlflow.start_run(run_name="Model-Batch-Deployment-lab-With-FS") as mlflow_run:
    ...
    model_name = f"ml_course.{DA.schema_name}.ml_model"
...
# Load the model
model_uri = f"models:/ml_course.default.ml_model@champion"
...
(
  ...
  .saveAsTable(f"ml_course.{DA.schema_name}.batch_inference_liquid_clustering")
)
